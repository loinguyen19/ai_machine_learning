...
- generated explanation (generated video) can be simple, 
- but:
  - coherent
  - useful
  - visibly connected to learner's query
...
Success metrics: in-memory persistence is acceptable if boudary is clearn
...
Testing, debugging, and reliability matter. 

Use your judgement on how much to implement within the time limit.
...
For this backend role, we will pay particular attention to:

- API clarity
- job-state handling
- error handling
- observability
- whether the generation boundary could realistically evolve into a production service.

We will also evaluate whether your generated videos are:
...
- your GitHub link
- please make sure `praveen.k@growtrics.ai` and `tech@growtrics.ai` have read access to the repository
